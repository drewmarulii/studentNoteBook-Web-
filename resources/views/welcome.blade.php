...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="
    ...
    <div class=" text-right" >
        <div class="text-right ">
            <h1>
                <strong>Student Notes</strong> & Tasks Record
            </h1>
            <h5>
                Easy note-taking and task-record in any circumstances.
            </h5>
        </div>
        <br>
        <br>
        <button class="btn">
            <a href="{{ url('register')}}" class="btn btn-primary btn-lg" aria-pressed="true">Create Account</a>
        </button>
        <br>
        <h5 class="pt-md-2" >
